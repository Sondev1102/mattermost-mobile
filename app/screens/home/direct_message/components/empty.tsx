...
import SavedPostsIcon from '../../saved_messages/components/saved_posts_icon';
    ...
    return (
        <View style={styles.container}>
            ...
            <FormattedText
                ...
                id='direct_messages.empty.title'
                style={styles.title}
            />
            {/* <FormattedText
                ...
                id='direct_messages.empty.paragraph'
...
export default EmptyDirectMessages;
